...
var DragonDetailComponent = /** @class */ (function () {
    function DragonDetailComponent(dragonService, route, spinner) {
        var _this = this;
    ...
    DragonDetailComponent.prototype.listDragon = function () {
        var _this = this;
        this.spinner.show();
        this.dragonService.listDragon(this.id).then(function (response) {
            _this.dragon = response;
            _this.spinner.hide();
        }).catch(function (err) {
            console.log(err);
            _this.spinner.hide();
    ...
    DragonDetailComponent.ctorParameters = function () { return [
...
var DragonsListComponent = /** @class */ (function () {
    function DragonsListComponent(dragonService, router, spinner, loginService, fb) {
        this.dragonService = dragonService;
        this.router = router;
        this.spinner = spinner;
    ...
    DragonsListComponent.prototype.listDragons = function () {
        var _this = this;
        this.spinner.show();
        this.dragonService.listDragons()
            .then(function (response) {
            _this.dragons = response;
            _this.dragons.sort(_this.ordena("name"));
            _this.spinner.hide();
        }).catch(function (err) {
            console.log(err);
            _this.spinner.hide();
    ...
    DragonsListComponent.prototype.verificaForm = function (name, type) {
        if (name) {
    ...
    // Cadastrando Dragão
    DragonsListComponent.prototype.newDragon = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.verificaForm(this.dragonN.get('name').hasError('required'), this.dragonN.get('type').hasError('required'))];
                    case 1:
                        if (_a.sent()) {
                            this.dragonService.newDragon(this.dragonN.get('name').value, this.dragonN.get('type').value)
                                .then(function (response) {
                                _this.dragons.push(response);
                                _this.dragons.sort(_this.ordena("name"));
                                _this.modal = false;
                                _this.dragonN.controls["name"].setValue("");
                                _this.dragonN.controls["type"].setValue("");
    ...
    DragonsListComponent.prototype.openEdit = function (index, dragon) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.modalEdit = true;
                this.index = index;
    ...
    // Editando dragão
    DragonsListComponent.prototype.editDragon = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var dragon;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.verificaForm(this.dragonN.get('name').hasError('required'), this.dragonN.get('type').hasError('required'))];
                    case 1:
                        if (_a.sent()) {
                            this.dragonService.editDragon(dragon)
                                .then(function (response) {
                                console.log(response);
                                _this.dragons[_this.index] = response;
                                _this.dragons.sort(_this.ordena("name"));
                                _this.modalEdit = false;
                                _this.dragonN.controls["id"].setValue("");
                                _this.dragonN.controls["name"].setValue("");
                                _this.dragonN.controls["type"].setValue("");
    ...
    // Deletar dragão
    DragonsListComponent.prototype.deleteDragon = function (id, index) {
        var _this = this;
        console.log(index);
        sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
            ...
            if (response.value) {
                _this.dragonService.deletedragon(id)
                    .then(function (response) {
                    console.log(response);
                    _this.dragons.splice(index, 1);
    ...
    DragonsListComponent.prototype.ordena = function (property) {
        var sortOrder = 1;
        if (property[0] === "-") {
            sortOrder = -1;
    ...
    DragonsListComponent.prototype.logout = function () {
        this.loginService.logout();
        this.router.navigate(['login']);
    };
    DragonsListComponent.ctorParameters = function () { return [
        { type: src_app_services_dragon_service__WEBPACK_IMPORTED_MODULE_2__["DragonService"] },
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.logar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.verificaForm()];
                    case 1:
                        if (_a.sent()) {
    ...
    LoginComponent.prototype.verificaForm = function () {
...
var LoggedGuard = /** @class */ (function () {
    function LoggedGuard(router, loginService) {
        this.router = router;
        this.loginService = loginService;
    }
...
var DragonService = /** @class */ (function () {
    ...
    DragonService.prototype.listDragons = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.apiUrl).subscribe(function (response) {
                resolve(response);
            }), function (err) {
                reject(err);
            };
    ...
    DragonService.prototype.listDragon = function (id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.apiUrl + '/' + id).subscribe(function (response) {
                resolve(response);
            }), function (err) {
                reject(err);
            };
    ...
    DragonService.prototype.newDragon = function (name, type) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.post(_this.apiUrl, { name: name, type: type }).subscribe(function (response) {
                resolve(response);
            }), function (err) {
                reject(err);
            };
    ...
    DragonService.prototype.editDragon = function (dragon) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.put(_this.apiUrl + '/' + dragon.id, { name: dragon.name, type: dragon.type }).subscribe(function (response) {
                resolve(response);
            }), function (err) {
                reject(err);
            };
    ...
    DragonService.prototype.deletedragon = function (id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.delete(_this.apiUrl + "/" + id).subscribe(function (response) {
                resolve(response);
            }), function (err) {
                reject(err);
            };
    ...
    DragonService.ctorParameters = function () { return [
...
var LoginService = /** @class */ (function () {
    ...
    Object.defineProperty(LoginService.prototype, "userLogado", {
        // Retorna user logado
        get: function () {
            return this.user;
        },
    ...
    // Seta storage
    LoginService.prototype.logar = function (login, senha) {
        var _this = this;
        return new Promise(function (resolve, reject) {
